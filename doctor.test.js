...
var newOpreation = adminDoctor.createNewActivity([
  "Raised the dead",
  "Healed the sick",
...
test("Doctor can create a new  Staff", function() {
  var newStaff = adminDoctor.createNewStaff(
    "Uchenna",
    "uche@gmail.com",
    "uche"
  );
...
//   Admin Doctor to delete All Staff Operations.
test("Doctor can delete All Operations", function() {
  expect(adminDoctor.deleteAllOperations()).toEqual({});
});
